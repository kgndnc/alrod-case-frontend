  ...
  return (
    <div className="bg-gray-100 rounded-2xl p-8 gap-4 flex flex-row items-center justify-between mb-6">
        ...
        <div className="grid grid-rows-2 gap-2">
          <div className="flex">
            ...
            <div>
              ...
              <div className="flex items-center text-2xl text-primary-gray mb-2">
      ...
      <div className="flex gap-2">
        <button className="bg-primary-blue text-white rounded-2xl px-6 py-4 text-sm font-medium flex items-center cursor-pointer">
